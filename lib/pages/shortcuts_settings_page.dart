...
class _ShortcutsSettingsPageState extends State<ShortcutsSettingsPage> {
  ...
  final Map<String, String> _actionDescriptions = {
    ...
    'volume_down': '减少音量',
    'speed_up': '播放倍速增加 0.1',
    'speed_down': '播放倍速减少 0.1',
    'speed_reset': '恢复到 1 倍速播放',
  ...
  final Map<String, IconData> _actionIcons = {
    ...
    'speed_up': Ionicons.speedometer_outline,
    'speed_down': Ionicons.speedometer_outline,
    'speed_reset': Ionicons.refresh_outline,
